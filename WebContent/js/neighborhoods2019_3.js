...
// Format is YEARMODY, i.e. [2018121]
...
var routesList = [
    ...
    {route: "2019126-1", neighborhoods: ["hamptongrove","valleycrest","barclaywoods","jordanscrossing","glaciercrest","cherryvale", "sunshineGrove"]},
    {route: "2019126-2", neighborhoods: ["mountainview","rockcreekmeadows","wildernessbrook","cantoncrossing","wildernessgrove_north","katesridge"]},
    
    {route: "2019127-1", neighborhoods: ["mapleridge","maplewoods"]},
    {route: "2019127-2", neighborhoods: ["meadowsatrockcreek","wildernessdowns","highlandscedardowns", "elkrun2"]},  
    
    {route: "20191213-1", neighborhoods: ["elkrun4","mapleglen","upper_diamondhills"]},
    {route: "20191213-2", neighborhoods: ["lower_diamondhills", "arborsmaplewoods","terracemaplewoods","rosewoodpark","glaciervalley"]},
    
    {route: "20191214-1", neighborhoods: ["valleymeadows","valleygreen","daybreak_upper", "patricksfair"]},
    {route: "20191214-2", neighborhoods: ["belmontcourt","belmonte","bellmontwoods", "foxPointe", "jaquelinemeadows"]},
    
    {route: "20191220-1", neighborhoods: ["haleysterrace","thereserve","eastwoodforest","elkrun3"]},
    {route: "20191220-2", neighborhoods: ["thewoods", "parkHaven", "lakepark", "highlandslakewilderness","arborsrockcreekfull", "lakeforestestates"]},
    
    {route: "20191221-1", neighborhoods: ["woodridge","highlandgreens","lwccdrive"]},
    {route: "20191221-2", neighborhoods: ["pebblecreek","shadowfirs","sawyercrest","greenbrier2"]},
    {route: "20191221-3", neighborhoods: ["lakewildernessvilla","watergardens"]},

    {route: "20190101-1", neighborhoods: ["lakewildernessvilla","watergardens", "pebblecreek","shadowfirs","sawyercrest","greenbrier2",
    ...
    // Covington
    {route: "2019126-4", neighborhoods: ["parkMeadowsRainierVista", "cornerstone"]},
    
    {route: "2019127-4", neighborhoods: ["mapleHills", "forestCreek", "shireHills"]}, 
    
    {route: "20191213-4", neighborhoods: ["woodcreek", "foxwood", "cohoCreek"]},
    
    {route: "20191214-4", neighborhoods: ["madisonView", "canaryHill", "heatherGlenn", "tahomaVista", "countryClubPlace", "avalonCourt", "mvcc"]},
    
    {route: "20191220-4", neighborhoods: ["stonefield", "highpointe", "fairfield"]},

    {route: "20191221-4", neighborhoods: ["tamarack", "croftinHeights", "croftinHills", "lakeWinterwood"]},
    
    {route: "20190101-4", neighborhoods: ["parkMeadowsRainierVista", "cornerstone", "mapleHills", "cedarCreekParke", "shireHills", "woodcreek", 
    "foxwood", "cohoCreek", "stonefield", "highpointe", "fairfield", "madisonView", "canaryHill", "heatherGlenn", "tahomaVista", "countryClubPlace", 
    "avalonCourt", "tamarack", "croftinHeights", "croftinHills", "lakeWinterwood", "mvcc"]},
...
var comboLatList = {
    ...
    "2019126-c": 47.370983,
    "2019127-c": 47.368017,
    "20191213-c": 47.369399,
    "20191214-c": 47.373965,
    "20191220-c": 47.366814,
    "20191221-c": 47.363456,
    "20190101-c": 47.363456
...
var comboLonList = {    
    ...
    "2019126-c": -122.098539,
    "2019127-c": -122.069892,
    "20191213-c": -122.111198,
    "20191214-c": -122.160159,
    "20191220-c": -122.125931,
    "20191221-c": -122.113826,
    "20190101-c": -122.113826    
    };

// Parse parties per route instead of day (was showing MV on Covington Map & opp)
var parties = {
    "2019127-2": [[47.369608, -122.057258], [47.354031, -122.045111]], 
    "20191213-2": [[47.350063, -122.024188]],
    "20191214-4": [[47.378562, -122.157982]],
    "20191220-1": [[47.349527, -122.053067]],
    "20191220-2": [[47.379562, -122.032871], [47.372832, -122.026794]],
    "20191221-1": [[47.369146, -122.040218]],
    "20191221-2": [[47.340736, -122.027880]]
};
